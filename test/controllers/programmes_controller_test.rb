...
class ProgrammesControllerTest < ActionController::TestCase
  ...
  test "should create programme" do
    assert_difference('Programme.count') do
      post :create, programme: { date: @programme.date, description: @programme.description, title: @programme.title }
    end
  ...
  test "should update programme" do
    patch :update, id: @programme, programme: { date: @programme.date, description: @programme.description, title: @programme.title }
    assert_redirected_to programme_path(assigns(:programme))
  end
